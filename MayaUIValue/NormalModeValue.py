...
class NormalModeValue(CoplanarJointOrient.MayaUIValue.ValueBase.ValueBase):
    ...
    def __init__(self, parentUI=None):
        ...
        if (parentUI is not None):
            self.rootUI = cmds.radioButtonGrp(label="Normal Mode:", parent=parentUI, numberOfRadioButtons=3,
                                              labelArray3=(
                                                  "Direction Vector", "2 Points and Direction Vector", "3 Points"),
                                              select=1, columnWidth4=(75, 110, 180, 75),
                                              onCommand1=functools.partial(NormalModeValue.onRadioChange, self,
                                                                           NormalModeValue.PLANE_NORMAL_MODE_VECTOR),
                                              onCommand2=functools.partial(NormalModeValue.onRadioChange, self,
                                                                           NormalModeValue.PLANE_NORMAL_MODE_2POINT_VECTOR),
                                              onCommand3=functools.partial(NormalModeValue.onRadioChange, self,
                                                                           NormalModeValue.PLANE_NORMAL_MODE_3POINT))
